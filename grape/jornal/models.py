...
class Location(models.Model):
    ...
    sort_id = models.ManyToManyField(SortGrape,blank=True, null=True, verbose_name='Сорт винограда из справочника', related_name='sorts')
    ...
    userid = models.ForeignKey(User, on_delete=models.CASCADE, blank=True, null=True, verbose_name='Пользователь')
    def __str__(self):
        return self.name
...
class Feeding(models.Model):
    dung_id = models.ManyToManyField(Dung, null=True, blank=True, verbose_name='подкормка из списка', related_name='dungs')
...
class Processing(models.Model):
    preparat_id = models.ManyToManyField(Preparats,  blank=True, verbose_name='препарат из списка', null=True, related_name='preparats')
